...
// @Transactional
// class DemandeScanTerminerControllerTest {
...
//     @Test
//     void postScanTerminer_redirigeVersPageScan() throws Exception {
...
//         mockMvc.perform(post("/demandes/{id}/scan-terminer", demande.getId()))
//             .andExpect(status().is3xxRedirection())
//             .andExpect(redirectedUrl("/demandes/" + demande.getId() + "/scan"));
//     }
// }
